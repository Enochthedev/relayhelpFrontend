      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <div className="p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#111827] mb-4">Ready to get started?</h2>
            <p className="text-gray-600 mb-8 max-w-lg mx-auto">
              Set up RelayHelp in minutes and start providing exceptional support through Discord.
            </p>
