...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-16 md:py-24 relative" style={{ background: "#FDF9F3" }}>
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden mb-12 md:mb-16">
          <div className="p-4 md:p-8 bg-gradient-to-r from-[#ED1C24] to-[#F05E23] text-white">
            <h3 className="text-xl md:text-2xl font-bold mb-1 md:mb-2">See RelayHelp in action</h3>
                        ...
                        <div className="bg-[#2F3136] rounded p-2 md:p-3 mb-2">
                          <div className="flex items-center">
                            <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-white flex items-center justify-center text-xs font-bold mr-2 p-1">
                              <svg viewBox="0 0 1140.89 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
        ...
        {/* Step summary */}
        <div className="grid gap-4 md:gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 max-w-5xl mx-auto">
          {demoSteps.map((step, index) => (
            ...
            >
              <div className="flex justify-center mb-3 md:mb-4">
                <div className="h-12 w-12 md:h-14 md:w-14 rounded-full bg-[#ED1C24] text-white flex items-center justify-center">
                  <span className="text-lg md:text-xl font-bold">{index + 1}</span>
                </div>
              </div>
              <h3 className="text-lg md:text-xl font-bold text-[#111827] mb-1 md:mb-2">{step.title}</h3>
              <p className="text-sm md:text-base text-[#111827]/80">{step.description}</p>
            </motion.div>
          ))}
        </div>
      </div>
